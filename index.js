  ...
  return __awaiter(void 0, void 0, void 0, function() {
    ...
    return __generator(this, function(_a) {
      ...
      if (input === "" || matches != null) {
        return [
          2 /*return*/,
          "Title can not contain numbers nor can it be empty! please enter again: "
        ];
      }
      ...
      switch (_b.label) {
        ...
        case 2:
          if (_a) {
            ...
            return [
              2 /*return*/,
              "This user could not be found! please try it again:"
            ];
          }
          return [2 /*return*/];
      }
...
var fromatingQuestoins = function(testing, contributing) {
  return __awaiter(void 0, void 0, void 0, function() {
...
Tests*/
  ...
  var des = "\n\n ## Description \n\n";
  var img =
    '<img width="75" height = "75" align = "right" src = "' +
    doc.avatar +
    '" />\n\n <p align="right"> created by <br> ' +
    doc.username +
    " <br>Email: " +
    doc.email +
    " </p>";
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            fs_1.promises.writeFile("TESTME.md", data, "utf8")
          ];
        case 1:
          _a.sent();
          return [3 /*break*/, 3];
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        ...
        case 3:
          ...
          _a.label = 4;
        case 4:
          return [4 /*yield*/, secondaryQuestoins()];
        case 5:
          addsections = _a.sent();
          (testing = addsections.testing),
            (contributing = addsections.contributing);
